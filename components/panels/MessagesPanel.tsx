        ...
        {conversations.map((conversation) => (
          ...
          >
            <div className="flex items-start gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-[#9A79FF] to-[#8A69EF] rounded-full flex items-center justify-center text-white font-semibold flex-shrink-0">
                {conversation.avatar}
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {conversation.unread > 0 && (
                    <span className="bg-[#9A79FF] text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0">
                      {conversation.unread}
                    </span>
                  )}
                </div>
