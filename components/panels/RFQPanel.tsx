    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            href="/account/rfq"
            className="flex items-center gap-2 bg-[#3373FF] hover:bg-[#265ACC] text-white px-4 py-2 rounded-lg text-sm font-medium transition"
          >
            <Plus size={16} />
            New RFQ
          </Link>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {rfqs.map((rfq) => (
          <div
            key={rfq.id}
            className="p-4 border border-gray-200 rounded-lg hover:border-[#3373FF] hover:bg-[rgba(154, 121, 255, 0.1)] transition mb-3 cursor-pointer"
          >
      ...
      {rfqs.length === 0 && (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link
              href="/account/rfq"
              className="inline-flex items-center gap-2 bg-[#3373FF] hover:bg-[#265ACC] text-white px-4 py-2 rounded-lg text-sm font-medium transition"
            >
              <Plus size={16} />
