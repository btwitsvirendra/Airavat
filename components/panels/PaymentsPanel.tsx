...
export default function PaymentsPanel() {
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      {/* Wallet Balance */}
      <div className="bg-gradient-to-r from-[#FF6A00] to-[#FF8C00] rounded-lg p-6 text-white mb-6">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 gap-3">
          <Link
            href="/account/wallet"
            className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-[#FF6A00] hover:bg-[#FFF4E6] transition cursor-pointer"
          >
            <div className="flex items-center gap-3">
              <Wallet size={24} className="text-[#FF6A00]" />
              <div>
          ...
          >
            <div className="flex items-center gap-3">
              <Link2 size={24} className="text-[#FF6A00]" />
              <div>
          ...
          >
            <div className="flex items-center gap-3">
              <Receipt size={24} className="text-[#FF6A00]" />
              <div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-sm text-[#FF6A00] hover:underline">Add New</button>
        </div>
        <div className="space-y-3">
          {paymentMethods.map((method) => (
            <div
              key={method.id}
              className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-[#FF6A00] transition"
            >
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                {method.default && (
                  <span className="px-2 py-1 bg-[#FFF4E6] text-[#FF6A00] text-xs font-medium rounded">Default</span>
                )}
                <ArrowRight size={16} className="text-gray-400" />
              </div>
            </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/account/transactions" className="text-sm text-[#FF6A00] hover:underline">
            View All
          </Link>
        </div>
        <div className="space-y-3">
