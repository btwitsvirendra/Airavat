              ...
              <div className="p-2 bg-white rounded-[15px] shadow-[0_10px_25px_0_rgba(0,0,0,0.075)] flex items-center justify-center">
                ...
                >
                  <span className="absolute left-[18px] w-[28px] h-[28px] flex-shrink-0 block pointer-events-none">
                    ...
                    {cart.length > 0 && (
                      <span className="absolute -top-1 -right-1 bg-[#9A79FF] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold z-20">
                        {cart.length}
                      </span>
                    )}
                  </span>
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800">
              <Link href="/" className="flex items-center gap-2">
                <svg className="h-8 text-[#9A79FF] dark:text-[#9A79FF]" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
