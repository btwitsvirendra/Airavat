    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          {activeTab === 'post' && (
            <a href="#" className="text-sm text-gray-600 hover:text-teal-600 flex items-center gap-1">
              How to Use
              <HelpCircle size={16} />
            </a>
          )}
        ...
        {activeTab === 'inquiries' ? (
          <div className="p-6">
            ...
            <div className="flex items-center gap-4 mb-6">
              <button className="flex items-center gap-2 bg-teal-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-teal-600 transition">
                All Inquires
                <ChevronDown size={16} />
              </button>
              ...
              <select
                ...
                className="flex items-center gap-2 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition focus:outline-none focus:ring-2 focus:ring-teal-500"
              >
                ...
                {mockInquiries.map((inquiry) => (
                  <div key={inquiry.id} className="grid grid-cols-12 gap-4 px-6 py-4 hover:bg-gray-50 transition">
                    ...
                    <div className="col-span-2 flex items-center justify-end">
                      <button className="bg-teal-500 hover:bg-teal-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition">
                        Chat
                      </button>
                    </div>
                  </div>
          ...
          <div className="p-6 max-w-4xl mx-auto">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-4 rounded-lg transition"
                >
                  Post RFQ
                </button>
              </div>
