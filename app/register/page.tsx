        ...
        <div className="flex-1 flex items-center justify-center p-8 overflow-y-auto">
          <div className="w-full max-w-md">
            ...
            <div className="flex gap-4 mb-6">
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-lg border-2 transition ${
                  formData.role === 'buyer'
                    ? 'border-[#9A79FF] bg-[rgba(154, 121, 255, 0.1)] text-[#9A79FF]'
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#9A79FF] focus:border-transparent outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="terms" className="text-sm text-gray-600">
                  ...
                  and{' '}
                  <Link href="/privacy" className="text-[#9A79FF] hover:underline">
                    Privacy Policy
                  </Link>
                </label>
              </div>
            ...
            <p className="text-center text-gray-600 mt-6">
              ...
              <Link href="/login" className="text-[#9A79FF] hover:underline font-semibold">
                Sign in
              </Link>
            </p>
          </div>
