      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[1920px] mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/rfq" className="bg-[#3373FF] hover:bg-[#265ACC] text-white px-6 py-2 rounded-lg font-semibold transition flex items-center gap-2">
              <Plus size={20} />
              Post an RFQ
            </Link>
          </div>
        ...
        <div className="flex gap-8">
          ...
          <aside className="w-64 flex-shrink-0 bg-white rounded-lg shadow-sm p-6 h-fit">
            <nav className="space-y-1">
              <Link href="/account" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 hover:text-[#3373FF]">
                <FileText size={20} />
                <span>My Airavat</span>
              </Link>
              <Link href="/account/rfq" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-[rgba(154,121,255,0.1)] text-[#3373FF] font-medium">
                <FileText size={20} />
                <span>My RFQs</span>
              </Link>
              <Link href="/orders" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 hover:text-[#3373FF]">
                <FileText size={20} />
                <span>Orders</span>
              </Link>
              <Link href="/messages" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 hover:text-[#3373FF]">
                <FileText size={20} />
                <span>Messages</span>
              </Link>
            </nav>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3373FF] focus:border-transparent"
                  />
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3373FF] focus:border-transparent"
                  >
            ...
            <div className="space-y-4">
              {filteredRFQs.length === 0 ? (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                  ...
                  <Link href="/rfq" className="inline-flex items-center gap-2 bg-[#3373FF] hover:bg-[#265ACC] text-white px-6 py-3 rounded-lg font-semibold transition">
                    <Plus size={20} />
                    Post an RFQ
                  </Link>
                </div>
